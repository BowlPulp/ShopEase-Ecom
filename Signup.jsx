    ...
    return (
        <section>
            <div class="flex h-screen md:flex-row flex-col">
                <div class="w-full md:w-1/2 bg-[#40534C] md:px-4">
                    <div class="h-screen flex items-center justify-center">
                        <div class='grid'>
                            ...
                            <p className="mt-2 text-base text-[#D6BD98] mb-5"> Already have an account?{' '}
                                <a href="#" title="" className="font-semibold text-black transition-all duration-200 hover:underline">Login here
                                </a> </p>
                            <form action="POST">
                                ...
                                <div class="flex flex-col gap-2 mt-5">
                                    ...
                                    <input className='w-full rounded-lg px-2 py-2 bg-inherit border-2 border-[#D6BD98]' type="password" placeholder='Confirm Password' />
                                </div>
                            </form>
                        <div className=''>
                            <div>
                ...
                <div class="w-full md:w-1/2 bg-[#7d7b67] flex justify-center items-center">
